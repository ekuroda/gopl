...
func TestReader(t *testing.T) {
	...
	if len(links) != 16 {
		t.Fatalf("len(links) = %d, want %d", len(links), 16)
	}

	if links[0] != "https://support.eji.org/give/153413/#!/donation/checkout" {
		t.Errorf("links[0] = %q, want %q", links[0], "https://support.eji.org/give/153413/#!/donation/checkout")
	}

	if links[15] != "https://google.com" {
		t.Errorf("links[15] = %q, want %q", links[15], "https://google.com")
	}
}
